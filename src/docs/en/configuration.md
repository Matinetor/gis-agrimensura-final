...
- `src/styles/css/main.css`: CSS style rules (original is in`src/styles/css`)
- `src/styles/images`: logos and other images
- `src/styles/images/legends`: the app searches by default in this location for images with the same name as the layers and adds them to layers buttons as a legend or preview
