...
$.getJSON("./src/config/data.json", async function (data) {
  $.getJSON("./src/config/preferences.json", async function (preferences) {
    gestorMenu.setLegendImgPath("src/styles/images/legends/");
  ...
  setTimeout(function () {
    ...
    if (loadElevationProfile) {
      $.getScript("https://code.highcharts.com/highcharts.js").done(() => {
        $.getScript("https://code.highcharts.com/highcharts-more.js").done(() => {
          // $.getScript("https://code.highcharts.com/modules/windbarb.js").done(() => {
          //   $.getScript("https://code.highcharts.com/modules/funnel.js").done(() => {
          //     $.getScript("https://code.highcharts.com/modules/exporting.js").done(() => {
          //       $.getScript("https://code.highcharts.com/modules/timeline.js").done(() => {
